...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Product-owned logo, headline, and release badge on the empty-session hero.',
    doc: 'Product-owned logo, headline, and release badge on the empty-session hero.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-xiaojing-product HeroBrand',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Product-owned brand row; the shell supplies its fold and navigation actions.',
    doc: 'Product-owned brand row; the shell supplies its fold and navigation actions.',
    registerOptions: [],
    ownerProps: [
    ...
    occupants: [
      'client-xiaojing-product SidebarBrand',
    ],
    replaceRisk: 'shadows-shipped-ui',
