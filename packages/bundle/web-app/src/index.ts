...
function webSurfacePrompt(webUrl: string): string {
  ...
  return `You are interacting with the user through the internally branded 小兢会计 Web app at ${webUrl}. `
  ...
  if (config.surfaceContext) {
    ...
    ctx.inject(['shellEnv'], (runtimeCtx) => {
      runtimeCtx.shellEnv.register({
        name: 'web-runtime',
        variables: {
          [DSH_WEB_URL]: { description: 'Canonical local URL of the 小兢会计 Web app serving this session.' },
        },
