...
| [`ui-weixin-channel/`](ui-weixin-channel/README.md) | Presents Xiaojing Weixin pairing and connection controls in settings. |
| [`ui-xiaojing-browser-control/`](ui-xiaojing-browser-control/README.md) | Presents the removable Xiaojing Edge/Chrome browser selection page. |
