...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /** Product-owned headline copy beside the blank-session brand mark. */
    'conversation.hero.brand.content': { kind: 'single'; scope: 'root'; owner: HeroBrandContentOwnerProps }
    /**
...
/** Empty owner share for product-owned blank-session headline copy. */
export interface HeroBrandContentOwnerProps {
  /** Marker field: the occupant owns its text and badge presentation. */
  children?: never
}
...
export type ConversationSlotProps =
  PropsRuntime<'conversation'> & PropsRenderSlots<
    ...
    | 'conversation.hero.brand.mark' | 'conversation.hero.brand.content'
