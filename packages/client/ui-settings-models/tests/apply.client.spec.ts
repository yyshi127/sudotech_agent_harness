...
describe('ui-settings-models apply', () => {
  ...
  it('registers the models nav entry for declarations before or after apply', async () => {
    ...
    expect(before.slots.spec('onboarding.content')).toEqual({ kind: 'single', scope: 'root' })
    ...
    expect(after.slots.spec('onboarding.content')).toEqual({ kind: 'single', scope: 'root' })
  ...
  it('re-registers after an HMR collapse re-declares the slot (stale disposer must not block)', async () => {
    ...
    expect(b.slots.spec('onboarding.content')).toEqual({ kind: 'single', scope: 'root' })
